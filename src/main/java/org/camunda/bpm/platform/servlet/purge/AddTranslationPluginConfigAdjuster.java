...
public class AddTranslationPluginConfigAdjuster extends ConfigAdjuster {
  ...
  protected DocumentContext adjustCustomScripts(DocumentContext customScriptsContext) {
    ...
    for (String local : locales) {
      ...
      customScriptsContext = addEntryToArray(customScriptsContext, arrayPath, arrayField, local);
    }
